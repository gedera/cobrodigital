...
| seguridad | [`docs/security/security.md`](docs/security/security.md) | secrets-semántica: sanitización de logs (sid + PII) y auth saliente al WS |
| datos · api · errores · eventos · multi-tenancy · data-lifecycle | n/a | ver Mapa de conocimiento en [`AGENTS.md`](AGENTS.md) |
